"""
Legacy Graph Configuration Schema (v2).

This module is retained for the bridge/upgrader runtime path.
New code should import from ``app.schemas.graph_config`` instead.
"""
