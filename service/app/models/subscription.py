...
class SubscriptionRoleBase(SQLModel):
    ...
    max_terminals: int = Field(default=1, description="Max concurrent terminal connections")
    max_deployments: int = Field(default=1, description="Max concurrent Settler deployments")
