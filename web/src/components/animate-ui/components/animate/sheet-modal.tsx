...
const BASE_PANEL =
  "relative overflow-hidden flex w-full flex-col rounded-t-2xl border-t border-neutral-200/30 bg-white/95 shadow-2xl shadow-black/20 backdrop-blur-xl dark:border-neutral-700/30 dark:bg-neutral-900/95 dark:shadow-black/40 md:rounded-2xl md:border md:border-neutral-200/20 [&>div]:overflow-hidden [&>div]:flex [&>div]:flex-col [&>div]:min-h-0";
