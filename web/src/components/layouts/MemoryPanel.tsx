...
export default function MemoryPanel() {
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-neutral-950 flex flex-col">
      {/* Header */}
      <div className="border-b border-neutral-200/80 dark:border-neutral-800 px-4 py-3 backdrop-blur-sm shrink-0">
      ...
      {/* Search */}
      <div className="border-b border-neutral-200/80 dark:border-neutral-800 px-4 py-2 shrink-0">
